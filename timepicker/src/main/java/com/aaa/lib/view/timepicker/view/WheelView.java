...
package com.aaa.lib.view.timepicker.view;
...
import com.aaa.lib.view.timepicker.util.DensityUtils;
import com.aaa.lib.view.timepicker.R;
import com.aaa.lib.view.timepicker.adapter.WheelAdapter;
import com.aaa.lib.view.timepicker.listener.OnWheelChangedListener;
...
public class WheelView extends View
{
     ...
     */
    private static final int VALUE_TEXT_COLOR = Color.parseColor("#FF9A4F");
     ...
     * Label Text size
     */
    private static int LABEL_TEXT_SIZE = 13;
    // Messages
    ...
    private void initData(Context context)
    {
        ...
        TEXT_SIZE = DensityUtils.sp2px(context, 14);
        LABEL_TEXT_SIZE = DensityUtils.sp2px(context, 8);
    }
    ...
    private void initResourcesIfNecessary()
    {
        ...
        {
            centerDrawable = getContext().getResources().getDrawable(R.drawable.shape_wheel_value);
        }
        ...
        setBackgroundResource(R.drawable.shape_wheelview_bg);
    }
