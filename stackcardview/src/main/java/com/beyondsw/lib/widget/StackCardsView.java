...
public class StackCardsView extends FrameLayout
{
    ...
    public StackCardsView(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        mItemWidth = a.getFraction(R.styleable.StackCardsView_itemWidth, 1, 1, 50);
        if (mItemWidth == INVALID_SIZE)
        {
            throw new IllegalArgumentException("itemWidth must be specified");
        }
        mItemHeight = a.getFraction(R.styleable.StackCardsView_itemHeight, 1, 1, 50);
        ...
        Log.i("buildLayoutParams", "aaaaaaaaaaa windows width : " + w_screen + "    height : " + h_screen + " density : " + density + "  dpi" + dpi);
        Log.i("buildLayoutParams", "aaaaaaaaaaa view width : " + getWidth() + "    height : " + getHeight());
    ...
    {
        Log.i("buildLayoutParams", "aaaaaaaaaaa view width : " + mItemWidth * getWidth() + "    height : " + (mItemHeight * getHeight()));
        return
//                new LayoutParams((int) (mItemWidth * getWidth()),(int) (mItemHeight * getHeight()), Gravity.CENTER)
                new LayoutParams(FrameLayout.LayoutParams.WRAP_CONTENT,FrameLayout.LayoutParams.WRAP_CONTENT, Gravity.CENTER)
